...
const { Option } = Select;
const CourseRequestList = ({ dataTable, onChangePage, meta, onEdit, pagination }) => {
          ...
          expandedRowRender: (record) => {
            return (
              <ul className="tw-text-xs">
                ...
                <li className="tw-py-2 tw-flex">
                  <span className=" tw-min-w-[130px] tw-inline-block tw-font-medium">Ảnh:</span>
                  <span>
                    <img src={record?.teacher?.image} width="50px" height="50px" alt="Hình ảnh không tồn tại" />{" "}
                  </span>
                </li>
                <li className="tw-py-2">
...
export default CourseRequestList;
