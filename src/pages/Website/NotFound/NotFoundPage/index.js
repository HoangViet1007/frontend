      ...
      <div className="tw-h-screen tw-w-screen tw-bg-gray-100 tw-flex tw-items-center">
        <div className="container tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-justify-center tw-px-5 tw-text-gray-700 sm:tw-px-0">
          <div className="tw-max-w-md tw-order-1 md:tw-order-0">
            <div className="tw-text-5xl tw-font-dark tw-font-bold tw-pb-5">
              404
            </div>
            <p className="tw-text-2xl md:tw-text-3xl tw-font-light tw-leading-normal tw-pb-2">
              Xin lỗi, chúng tôi không thể tìm thấy trang này.
            </p>
            <p className="tw-mb-8">
              Nhưng đừng lo lắng, bạn có thể tìm thấy rất nhiều thứ khác trên
