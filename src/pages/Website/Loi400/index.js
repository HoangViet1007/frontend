...
const Page401 = () => {
  return (
    <>
      <PageTitle namePage="error 400" />
      <div className="tw-h-screen tw-w-screen tw-bg-gray-100 tw-flex tw-items-center">
        <div className="container tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-justify-center tw-px-5 tw-text-gray-700 sm:tw-px-0">
          <div className="tw-max-w-md tw-order-1 md:tw-order-0">
            {/* <div className="tw-text-5xl tw-font-dark tw-font-bold tw-pb-12">Mã lỗi 400</div> */}
            <p className="tw-text-2xl md:tw-text-3xl tw-font-light tw-leading-normal tw-pb-12">
              Bạn vui lòng xác nhận thực email để sử dụng hệ thống.
            </p>
            <Link to="/">
              <button className="theme-btn btn-style-three hover:tw-text-white">
                <span className="tw-relative tw-z-[1]">Quay lại trang chủ</span>
              </button>
            </Link>
          </div>
          <div className="tw-max-w-lg tw-order-0 md:tw-order-1">
            <svg
              id="Layer_1"
              data-name="Layer 1"
